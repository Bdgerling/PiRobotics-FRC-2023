...
public class Robot extends TimedRobot {
  ...
  PIDController pid90 = new PIDController(0.024, 0.0, 0.008);//swithing p from 0.015 to 0.02 switching d from 0.005 to 0.007 to 0.008
  PIDController pid180 = new PIDController(0.024, 0.00, 0.012);
